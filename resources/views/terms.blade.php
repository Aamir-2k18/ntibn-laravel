...
<section id="speakers" class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>This website is operated by Northern Territory Indigenous Business Network (NTIBN).
                        Throughout the site, the terms “we”, “us” and “our” refer to NTIBN. NTIBN offers this
                        ...
                        here.
                        By visiting our site and/ or making a booking with us, you engage in our “Service” and agree
                        to be bound by the following terms and conditions (“Terms of Service”, “Terms”). These Terms
                        of Service apply to all users of the site, including without limitation users who are
...
<section id="section1" class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
    <div class="container">
        <div class="section-header">
            <h3>ONLINE BOOKING TERMS</h3>
        </div>
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
...
<section id="section2" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section3" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section4" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section5" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section6" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>We reserve the right to refuse any order you place with us. We may, in our sole discretion,
                        ...
                        For more detail, please review our <a href="refund-policy.php"> Refunds Policy</a>.
                    </p>
                </div>
            </div>
            <div class="col-sm-1"></div>
...
<section id="section7" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section8" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section9" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section10" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>Your submission of personal information through the store is governed by our Privacy Policy.
                        To view our <a href="privacy-policy.php"> Privacy Policy</a>.</p>
                </div>
            </div>
            <div class="col-sm-1"></div>
        </div>
...
<section id="section11" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section12" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section13" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>We do not guarantee, represent or warrant that your use of our service will be uninterrupted,
                        ...
                        In no case shall NTIBN our directors, officers, employees, affiliates, agents, contractors,
...
<section id="section14" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>You agree to indemnify, defend and hold harmless NTIBN and our affiliates, partners,
                        ...
                        of Service or the documents they incorporate by reference, or your violation of any law or
...
<section id="section15" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            <h3>SEVERABILITY</h3>
        </div>
...
<section id="section16" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            <h3>TERMINATION</h3>
        </div>
...
<section id="section17" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section18" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
...
<section id="section19" class="wow fadeInUp" style="visibility: hidden; animation-name: none;">
    <div class="container">
        <div class="section-header">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <p>Questions about the Terms of Service should be sent to us at <a
                            href="mailto:membership@ntibn.com.au"> membership@ntibn.com.au</a></p>
                </div>
            </div>
            <div class="col-sm-1"></div>
        </div>
